...
<!--  Show Data  -->
    <script>
        ...
        function fetchData() {
            $.ajax({
                type: 'GET',
                url: 'fetch_data.php', // Replace with the actual path to your PHP script
                dataType: 'json',
                success: function (data) {
                    ...
                    $.each(data, function (index, row) {
                      //  var editButton = '<button class="btn btn-primary" onclick="editData(' + row.id + ')">Edit</button>';
                        var editButton = '<button class="btn btn-info" onclick="editData(' + row.id + ')">Edit</button>';

                        var deleteButton = '<button class="btn btn-danger" onclick="deleteData(' + row.id + ')">Delete</button>';
